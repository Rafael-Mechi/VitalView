	...
	('Servidor Principal', '192.168.0.10', 'ala01', 2),
	('Servidor Backup', '192.168.0.11', 'ala2', 2),
	...
	('srv2', '192.0.0.1', 'Sala dos servidores', 2, 2);

	insert into servidores(hostname, ip, localizacao, fkHospital, fkUsuario) values
	('srv3', '192.0.0.2', 'Sala dos servidores', 2, 2);
